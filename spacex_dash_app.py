...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                #html.Div(["Input:",dcc.Input(id='site-dropdown',value='value',type='number',style={'height':'50px','font-size':35}),],
	                            #style={'font-size':40}),
...
def get_scatter_plot(entered_site,payload_range):
    ...
    mask=(filtered_df['Payload Mass (kg)']>low) & (df['Payload Mass (kg)']<high)
    if entered_site == 'ALL':
